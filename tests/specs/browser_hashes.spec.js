...
test.describe('REX Page Manipulation: Hash Generation and Manipulation', () => {
  test('add_class with no conditions applies the class unconditionally.', async ({ page }) => {
  ...
  test('add_class condition selects exactly the within_range indices', async ({ page }) => { // eslint-disable-line no-unused-vars
    await page.goto(linksPageURL)
  ...
  test('add_class content.within reads the hash input from a descendant', async ({ page }) => { // eslint-disable-line no-unused-vars
    await page.goto(linksPageURL)
  ...
  test('add_class exceptions veto a domain even when it is in range', async ({ page }) => { // eslint-disable-line no-unused-vars
    await page.goto(linksPageURL)
  ...
  test('add_class conditions_match "all" classes only elements passing every condition', async ({ page }) => { // eslint-disable-line no-unused-vars
    await page.goto(linksPageURL)
  ...
  test('add_class conditions_match "any" classes elements passing at least one condition', async ({ page }) => { // eslint-disable-line no-unused-vars
    await page.goto(linksPageURL)
  ...
  test('add_class reports evaluated and matched counts via logEvent', async ({ page }) => {
    await page.goto(linksPageURL)
  ...
  test('add_class logs the exact matched and unmatched domain lists via logEvent', async ({ page }) => {
    await page.goto(linksPageURL)
  ...
  test('add_class logs exception-vetoed domains in a separate excepted list', async ({ page }) => {
    await page.goto(linksPageURL)
